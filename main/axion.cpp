...
void app_main(void)
{
    atReady = xEventGroupCreate();
    mpuReady = xEventGroupCreate();
    ...
    xTaskCreate(TaskFunction_t(get_rpy), "rpy", 8192, nullptr, 2, nullptr);
    ...
    xTaskCreate(TaskFunction_t(monitor_task), "monitor", 4096, nullptr, 1, nullptr);
}
